...
(
    ...
    CONSTRAINT fk_cart_id_cart_items FOREIGN KEY (cart_id) REFERENCES oe.carts (cart_id) on delete cascade,
    CONSTRAINT fk_product_id_cart_items FOREIGN KEY (product_id) REFERENCES oe.products (product_id) on delete cascade
);