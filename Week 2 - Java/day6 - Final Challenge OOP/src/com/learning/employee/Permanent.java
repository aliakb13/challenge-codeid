...
public class Permanent extends Employee implements AllowanceService, TaxService {
    private final List<Allowances> allowances;
    private final PphTaperaTax tax;

    public Permanent(String fullName, LocalDate hireDate, double salary, List<Allowances> allowances, PphTaperaTax tax) {
        super(fullName, hireDate, Status.Permanent, salary);
